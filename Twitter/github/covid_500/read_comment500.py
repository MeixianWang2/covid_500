...
for item in items:
    try:
        ...
        sql = "insert into comment(screen_name,created_at,tweet_id,text,in_reply_to_screen_name, in_reply_to_status_id, in_reply_to_user_id,language) values (%s,%s,%s,%s,%s,%s,%s,%s)"
        print('sql')
