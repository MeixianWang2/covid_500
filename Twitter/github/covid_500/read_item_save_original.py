...
for item in items:
    ...
    # delete retweet and reply
            if item['text'][0:2] == 'RT':
                ...
                continue
            elif item['in_reply_to_screen_name'] is None:
                try:
                    ...
                    print(t)
                    sql = "insert into tweet_500_original(screen_name,created_at,tweet_id,text,extended_tweet,retweet_count,in_reply_to_screen_name,in_reply_to_status_id, in_reply_to_user_id,favorite_count,language) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                    print('sql')
