...
with open('covid_startup.json', 'r') as file:
...
for item in items:
    ...
    try:
        ...
        print(t)
        sql = "insert into covid_startup1(screen_name,created_at,tweet_id,text,extended_tweet,quote_count,reply_count,retweet_count,favorite_count,language) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
        print('sql')
