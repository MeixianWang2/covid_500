...
base_dir = '/Volumes/EDrive/COVID-19-TweetIDs/2020-04'
        ...
        for item in json_content:
            ...
            if language == 'en':
                ...
                try:
                    ...
                    sql = "insert into covid(screen_name,created_at,tweet_id,text,retweet_count,favorite_count,in_reply_to_screen_name,in_reply_to_status_id, in_reply_to_user_id,geo,coordinates,place,language) values (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
                    print('sql')
